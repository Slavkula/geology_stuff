...
text = """
Программа заполняет ведомость.
1. Делай копию ведомости и работай в ней.
2. Создаёшь в ведомости лист "Лист1"
И копируешь туда полностью генератор.
3. Вставляешь в генератор диапазон чисел
Ну как мы обычно делаем для каждого ИГЭ.
Сохраняешь всё и закрываешь на листе 1.
4. Пишешь ячейки из генератора.
5. Пишешь столбец для сверки ИГЭ,
Записанные тобой ниже будут проверяться
по этому столбцу.
6. Вводишь ИГЭ, выбираешь столбец вставки.
7. Тык! Тык!
8. Программу можно не открывать заново, а
эксель нужно будет закрыть.
"""
